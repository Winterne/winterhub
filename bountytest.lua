spawn(function()
		...
		hookfunction(print, function(...)
			game.Players.LocalPlayer:Kick("Anti Http Spy By Winter hub ")
			game:Shutdown()
			while true do end
			return
		end)
...
TextLabel.Text = "Winter Hub Bounty"
...
TextLabel1.Text = "Winter Hub Bounty"
...
SkipImg.Image = "rbxassetid://17179235821"
